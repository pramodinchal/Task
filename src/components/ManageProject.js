    ...
    <div className="container4">
      ...
      <div className="blocks">
        <div id="block1" style={{ display: "block", alignItems: "center" }}>
          ...
          <span id="span">Everyone</span>
          <p id="p">
            All users can now see to it,but guests cannot <br /> access the
            projects.
          </p>
        </div>
      </div>
      <div className="block2">
        <div style={{ display: "block", alignItems: "center" }}>
          ...
          <span id="span">Only Admin's</span>
          <p id="p1">Only admins can manage everything.</p>
        </div>
      </div>
      <div className="block3">
        <div style={{ display: "block", alignItems: "center" }}>
          <img src="specific.png" alt="My Image" id="imgspecific" />
          <span id="span">Only to Specific people</span>
          <p id="p1">Only some specific people can be able to see.</p>
        </div>
      </div>
